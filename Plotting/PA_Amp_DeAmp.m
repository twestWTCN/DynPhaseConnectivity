        ...
        for side = 1:2
            for cond = 1:length(R.condname)
                ...
                if vc_clean.specanaly.flag ~= 1 % Check significant coherences
                    ...
                    OVL(cond,side,sub) = vc_clean.PA.OVL;
                    ...
                    surrAmp = vc_clean.PA.surrAmp(end);
                    ...
                    for i = 1:4
                        ...
                        drawDur(1,i,cond,side,sub) = (median(seg_dist(draw_inds))/tottime)*100;
                        ...
                        drawDur(2,i,cond,side,sub) = (median(seg_dist(1,draw_inds))/tottime)*100;
